...
function HotelAdd() {
    ...
    return (
        <Container className="bg-white rounded shadow-sm p-2">
            <Row>
                <Col>
                    <h3 className="fs-2 fw-bold">Добавить гостиницу</h3>

                    <form className="mb-3" onSubmit={onSubmit}>
                        <div className="form-group mb-3">
                            <label>Наименование отеля</label>
                            <input type="text" className="form-control mb-3" placeholder="Наименование"
                        ...
                        <div className="form-group mb-3">
                            ...
                            <textarea rows={7} className="form-control mb-3" maxLength={5000}
                                      placeholder="Описание отеля" onChange={(e) => setDescription(e.target.value)}/>
                        </div>
